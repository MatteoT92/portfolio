            ...
            <div>
                <div class="ide">
                    ...
                    <code>
                        ...
                        <span className="line-numbers">8</span>Durante lo stage, ho avuto modo di poter lavorare in team su progetti e apprendere nuove tecnologie quali: <strong>Angular</strong>, <strong>React</strong>, <strong>TypeScript</strong>, <strong>Spring</strong>, <strong>JUnit Test</strong>, <strong>Git</strong>, <strong>Bash</strong>.<br/>
                        <span className="line-numbers">9</span>Alcuni di questi progetti sono anche pubblicati sul mio profilo <a href="https://github.com/MatteoT92">GitHub</a>.<br/>
                        <span className="line-numbers">10</span>Nel caso li volessi dare un'occhiata? &#128521;
                    </code>
                </div>
                <Footer />
            </div>
